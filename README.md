...
Run `npm run validate` after changing campaign content. The validator checks all nine levels, item-to-container answers, label visibility, bin order, and referenced artwork files.
