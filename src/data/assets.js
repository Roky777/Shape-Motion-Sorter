...
const levelArt = {
  level1: { pencil: "LEVEL 1+2/pencil.webp", ball: "LEVEL 1+2/ball (1).webp", ruler: "LEVEL 1+2/scale (1).webp", orange: "LEVEL 1+2/orange (1).webp", stick: "LEVEL 1+2/stick.svg", candle: "LEVEL 1+2/candle.webp", plate: "LEVEL 1+2/plate (1).webp", rope: "LEVEL 1+2/rope.webp", bangle: "LEVEL 1+2/ring (1).webp", coin: "LEVEL 1+2/coin (1).webp" },
  level2: { pencil: "LEVEL 1+2/pencil.webp", ball: "LEVEL 1+2/ball (1).webp", ruler: "LEVEL 1+2/scale (1).webp", orange: "LEVEL 1+2/orange (1).webp", stick: "LEVEL 1+2/stick.svg", candle: "LEVEL 1+2/candle.webp", plate: "LEVEL 1+2/plate (1).webp", rope: "LEVEL 1+2/rope.webp", bangle: "LEVEL 1+2/ring (1).webp", coin: "LEVEL 1+2/coin (1).webp" },
  ...
  level8: { football: "level 8/football.webp", orange: "level 8/orange.webp", marble: "level 8/marble.webp", matchbox: "level 8/matchbox.webp", book: "level 8/book.webp", pencilbox: "level 8/stationary box.webp", bottle: "level 8/water_bottle (1).webp", can: "level 8/tin can (1).webp", cylinder: "level 8/toy cylinder (1).webp", cylindrical: "level 8/cylindrical container (1).webp" },
  level9: { football: "level 9/football.webp", orange: "level 9/orange.webp", clayball: "level 9/clay ball.webp", matchbox: "level 9/matchbox.webp", book: "level 9/book.webp", cardboard: "level 9/cardboard box.webp", bottle: "level 9/water_bottle.webp", can: "level 9/tin can (1).webp", cylinder: "level 9/toy cylinder (1).webp", cylindrical: "level 9/cylindrical container (1).webp" },
};
...
export const assets = {
  ...
  items: {
    math: {
      ...
      stick: "assets/GRADE 1/maths game/LEVEL 1+2/stick.svg",
      ...
      coin: "assets/GRADE 1/maths game/LEVEL 1+2/coin (1).webp",
