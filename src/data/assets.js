...
const levelArt = {
  level1: { pencil: "LEVEL 1+2/pencil.png", ball: "LEVEL 1+2/ball (1).png", ruler: "LEVEL 1+2/scale (1).png", orange: "LEVEL 1+2/orange (1).png", stick: "LEVEL 1+2/stick.svg", candle: "LEVEL 1+2/candle.png", plate: "LEVEL 1+2/plate (1).png", rope: "LEVEL 1+2/rope.png", bangle: "LEVEL 1+2/ring (1).png", coin: "LEVEL 1+2/coin (1).png" },
  level2: { pencil: "LEVEL 1+2/pencil.png", ball: "LEVEL 1+2/ball (1).png", ruler: "LEVEL 1+2/scale (1).png", orange: "LEVEL 1+2/orange (1).png", stick: "LEVEL 1+2/stick.svg", candle: "LEVEL 1+2/candle.png", plate: "LEVEL 1+2/plate (1).png", rope: "LEVEL 1+2/rope.png", bangle: "LEVEL 1+2/ring (1).png", coin: "LEVEL 1+2/coin (1).png" },
  ...
  level8: { football: "level 8/football.png", orange: "level 8/orange.png", marble: "level 8/marble.png", matchbox: "level 8/matchbox.png", book: "level 8/book.png", pencilbox: "level 8/stationary box.png", bottle: "level 8/water_bottle (1).png", can: "level 8/tin can (1).png", cylinder: "level 8/toy cylinder (1).png", cylindrical: "level 8/cylindrical container (1).png" },
  level9: { football: "level 9/football.png", orange: "level 9/orange.png", clayball: "level 9/clay ball.png", matchbox: "level 9/matchbox.png", book: "level 9/book.png", cardboard: "level 9/cardboard box.png", bottle: "level 9/water_bottle.png", can: "level 9/tin can (1).png", cylinder: "level 9/toy cylinder (1).png", cylindrical: "level 9/cylindrical container (1).png" },
};
...
export const assets = {
  ...
  items: {
    math: {
      ...
      coin: "assets/GRADE 1/maths game/LEVEL 1+2/coin (1).png",
